...
rolling_test_zoo <-
  joined_data[ ,
               `:=` (mean_roll_1day = rollmean(x = meter_reading_log,
                                               k = 24,
                                               na.pad = TRUE,
                                               align = "right"
                                               ),
                     mean_roll_2day = rollmean(x = meter_reading_log,
                                               k = (24 * 2),
                                               na.pad = TRUE,
                                               align = "right"
                                               ),
                     mean_roll_7day = rollmean(x = meter_reading_log,
                                               k = (24 * 7),
                                               na.pad = TRUE,
                                               align = "right"
                                               )
